...
export const Hero = () => {
  return (
    <section className="relative min-h-[80vh] bg-black flex flex-col md:flex-row items-center justify-between px-6 py-12 md:px-20 overflow-hidden">
      ...
      <div className="w-full md:w-1/2 z-10 text-left space-y-6">
        ...
        <h1 className="text-4xl md:text-7xl font-serif text-white tracking-tighter leading-tight">
          RESVERABIO®
        </h1>
      ...
      <div className="w-full md:w-1/2 mt-12 md:mt-0 flex justify-center relative">
        <div className="relative group">
          {/* Brilho de fundo para destacar o produto */}
          <div className="absolute inset-0 bg-[#bfa67a]/10 blur-[100px] rounded-full"></div>
          <img 
            src="/resverabio-hero2.png" 
            alt="Resverabio Premium" 
            className="relative w-full h-auto max-w-[500px] object-contain drop-shadow-2xl transition-transform duration-700 hover:scale-105"
          />
          {/* Selo de Preço fixo conforme o print Hero.certo.jpeg */}
