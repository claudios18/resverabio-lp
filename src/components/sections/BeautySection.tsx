    ...
    >
      <Container>
        ...
        <div className="mt-12 md:mt-16 lg:mt-20 text-center">
          ...
          >
            RESVERABIO® é mais do que um suplemento — é um convite para sentir-se radiosa novamente. 
            Sua fórmula sinérgica trabalha em profundidade para devolver o <strong>viço natural da pele</strong>, 
            hidratando de dentro para fora com Colágeno Premium e Ácido Hialurônico, potencializados 
            pelo poder antioxidante do Resveratrol puro. 
            <br /><br />
            E porque sabemos que os cabelos são sua coroa, a combinação única de Niacina (Vitamina B3) 
            com nosso complexo vitamínico (A, B3 e C) ajuda a <strong>fortalecer os fios</strong>, 
            reduzir a queda e devolver o brilho que o tempo foi levando embora. Uma fórmula rara e original, 
